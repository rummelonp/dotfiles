...
# idea
if [[ $OSTYPE =~ darwin ]]; then
    link_dir idea/colors  "Library/Application Support/Google/AndroidStudio2022.1/colors"
    link_dir idea/keymaps "Library/Application Support/Google/AndroidStudio2022.1/keymaps"
fi
