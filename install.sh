...
# idea
if [[ $OSTYPE =~ darwin ]]; then
    link_dir idea/colors  "Library/Application Support/Google/AndroidStudio2022.3/colors"
    link_dir idea/keymaps "Library/Application Support/Google/AndroidStudio2022.3/keymaps"
fi
